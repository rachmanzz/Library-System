...
<div class="alert alert-danger">
  <center>You currently dont have any books</center>
</div>
@else
  ...
  @foreach($books as $book)
    <tr>
      ...
      <td><center>{{$book->stock}}</center></td>
       ...
       <td class="text-center"><button type"submit" class="btn btn-danger" id="button" />Delete Book</td>
    </tr>
  @endforeach
  </tbody>
</table>
@endif
  {!!Form::open(['route'=>['admin.doDeleteBooks',Auth::user()->username]] )!!}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <p><span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;Author&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="input-lg" id="author" name="author" readonly="readonly" /></p>
      ...
      <div class="modal-footer">
        <input type="submit" class="btn btn-danger" value="Delete Book" name="button" />
